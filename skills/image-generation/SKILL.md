...
| **文生图/文图生图** | Midjourney (MJ) | `mj_imagine_client.py` | 对接 `/mj/submit/imagine` + `/mj/task/{id}/fetch`，支持轮询与下载。 |
...
**脚本**: `skills/image-generation/scripts/mj_imagine_client.py`
...
**文生图示例**:
```bash
python skills/image-generation/scripts/mj_imagine_client.py \
